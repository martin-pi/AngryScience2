package com.pharaoh439.angrysciencemod;
...
@Mod("angrysciencemod")
public class AngryScienceMod
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MOD_ID = "angrysciencemod";
    public static AngryScienceMod instance;

    public AngryScienceMod() {
    ...
    // enqueueIMC and processIMC are meant for inter-mod compatibilities. We won't need them for now.
